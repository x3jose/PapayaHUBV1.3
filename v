...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = True,
       Invite = "XupCKvSBeS", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
 ...
 local Section = Tab:CreateSection("Trolling Section...")
 ...
 local Slider = Tab:CreateSlider({
   ...
   Callback = function(Value)
       ...
       print("Changed Walkspeed to :", Value)
   end,
})
...
local Slider = Tab:CreateSlider({
   ...
   Callback = function(Value)
       ...
       print("Changed JumpPower to :", Value)
   end,
})
